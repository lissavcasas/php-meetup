 ...
 */
    ...
    class DEMO_USERSPage extends Page
    {
        ...
        {
            $this->SetTitle('LISTA DE ASISTENTES');
            $this->SetMenuLabel('LISTA DE ASISTENTES');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'USER_PHOTO', 'USER_PHOTO', 'Foto')
            );
        }
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new ExternalImageViewColumn('USER_PHOTO', 'USER_PHOTO', 'Foto', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new UploadFileToFolderColumn('Foto', 'USER_PHOTO', $editor, $this->dataset, false, false, 'BIG_IMAG', '%original_file_name%', $this->OnFileUpload, false);
    ...
    try
    {
        $Page = new DEMO_USERSPage("DEMO_USERS", "LISTA DE ASISTENTES.php", GetCurrentUserPermissionSetForDataSource("DEMO.USERS"), 'UTF-8');
